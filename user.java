...
public abstract class user {
    ...
    ArrayList<message> messageList = new ArrayList(10);
    ...
    public void findFriends(ArrayList<user> usersList) {
        try {
    ...
    public void getUsersByHashtag(String hashtag){
        
    }
    public void getPostsByHashtag(String hashtag){
    ...
    public void viewTimline() {
        for (user usersList1 : this.userFriends) {
            if (usersList1.posts.size() == 0) {
